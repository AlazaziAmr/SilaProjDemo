...
function silaValReg(){
    ...
    if(document.getElementById('validationCustom01').value == ""){
        document.getElementById('').innerHTML('first name is empty');
    }
    else if(!document.getElementById('validationCustom01').value.match(regex)){
        document.getElementById('').innerHTML('first name is no correct');
    }
    else if(document.getElementById('validationCustom09').value == ""){
        document.getElementById('').innerHTML('Last Name is empty');
    }
    else if(!document.getElementById('validationCustom09').value.match(regex)){
        document.getElementById('').innerHTML('Last Name is no correct');
    }
    else if(document.getElementById('validationCustom07').value == ""){
        document.getElementById('').innerHTML('enter your street address');
    }
    else if(document.getElementById('validationCustom05').value == ""){
        document.getElementById('').innerHTML('enter your city');
    }
    else if(document.getElementById('validationCustom06').value == ""){
        document.getElementById('').innerHTML('enter your state');
    }
    else if(document.getElementById('validationCustom08').value == ""){
        document.getElementById('').innerHTML('enter your ZIP code');
    }
    else if(document.getElementById('validationCustom03').value == ""){
        document.getElementById('').innerHTML('ssn is empty');
    }
    else if(document.getElementById('validationCustom04').value == ""){
        document.getElementById('').innerHTML('birth date is empty');
    }
    else if(!document.getElementById('formGroupExampleInput1').value.match(mailformat)){
        document.getElementById('').innerHTML('Email you entered is incorrect');
    }
    else if(document.getElementById('formGroupExampleInput2').value == ""){
        document.getElementById('').innerHTML('Enter phone number');
    }
    else
    {
...
function amanahValReg(){
    ...
    // else{
    //     alert('your data is success');
    //     document.getElementById('amanahReg').setAttribute('type','submit');
    // }
...
//         document.getElementById('passCharacters').classList.replace('text-danger','text-success');
//     }
//     else{
//         document.getElementById('passCharacters').classList.remove('text-success');
//     }
//     if(document.getElementById('pass').value.search(/[0-9]/)){
//         document.getElementById('passNumeric').classList.replace('text-danger','text-success');
//     }
//     else{
//         document.getElementById('passNumeric').classList.remove('text-success');
//     }
//     if(document.getElementById('pass').value.search(/[a-z]/)){
//         document.getElementById('passLowerCase').classList.replace('text-danger','text-success');
//     }
//     else{
//         document.getElementById('passLowerCase').classList.remove('text-success');
//     }
//     if(document.getElementById('pass').value.search(/[A-Z]/)){
//         document.getElementById('passUpperCase').classList.replace('text-danger','text-success');
//     }
//     else{
//         document.getElementById('passUpperCase').classList.remove('text-success');
//     }
//     if(document.getElementById('pass').value.search(/[!\@\#\$\%\^\&\*\(\)\-\_\=\+\<\,\>\?]/)){
//         document.getElementById('passSpecialSymbol').classList.replace('text-danger','text-success');
//     }
//     else{

                    ...
                    <div class="reg1" id="reg1">
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom09" placeholder="Last Name" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom07" placeholder="Street Address" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom08" placeholder="ZIP Code" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="validationCustom03" placeholder="SSN" required>
